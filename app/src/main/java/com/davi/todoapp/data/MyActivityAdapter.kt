...
import com.davi.todoapp.R

class MyActivityAdapter(var context:Context,var list: ArrayList<ActivityModel>): RecyclerView.Adapter<MyActivityAdapter.ActivityViewHolder>() {
